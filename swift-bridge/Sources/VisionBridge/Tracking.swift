// Vision v0.14 tracking-request coverage — stateful trackers.
//
// These wrap the request + retained sequence handler behind opaque raw
// pointers so Rust can drive them as safe session objects.
